...
class AppPref(var context: Context) {
    ...
    //okuma işlemi
    //corutine asenkron çalıştığı gösterir dha performanslı
    ...
    suspend fun okuAd():String{
        ...
        return p[AD_KEY]?:"isim yok"//sorun olursa stringi kullanır
    }
    suspend fun sil(){
        context.ds.edit {
            it.remove(AD_KEY)
    ...
    suspend fun kayitArkadasListesi(liste:Set<String>){
        context.ds.edit {
